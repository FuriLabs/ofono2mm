...
class DBusInterfaceProperties:
    ...
    class DBusInterface:
        ...
        """
        def __init__(self, ofono_proxy, interface):
            ...
            while retries_left > 0:
                try:
                    ...
                    if retries_left > 0:
                        ...
                        ofono2mm_print(f"Interface {self.interface} doesn't have properties? {e}", True)
    ...
    def __getitem__(self, interface: str) -> Dict[str, any]:
        ...
        self.interfaces[interface] = self.DBusInterface(self.ofono_proxy, interface)
...
class MMModemInterface(ServiceInterface):
    def __init__(self, loop, index, bus, ofono_client, modem_name, verbose=False):
        ...
        self.ofono_interface_props = DBusInterfaceProperties(self.ofono_proxy)
