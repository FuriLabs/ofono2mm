...
class MMModemCellBroadcastInterface(ServiceInterface):
    ...
    def add_incoming_broadcast(self, text, topic):
        ...
        self.bus.export(f'/org/freedesktop/ModemManager1/CBM/{cbm_i}', mm_cbm_interface)
        self.props['CellBroadcasts'].value.append(f'/org/freedesktop/ModemManager1/CBM/{cbm_i}')
        self.emit_properties_changed({'CellBroadcasts': self.props['CellBroadcasts'].value})
        self.Added(f'/org/freedesktop/ModemManager1/CBM/{cbm_i}')
        cbm_i += 1
